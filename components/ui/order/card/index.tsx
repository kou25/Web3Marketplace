            ...
            <div className="mt-2">
              <div className="mt-1 relative rounded-md w-72">
                <input
                  ...
                  name="price"
                  id="price"
                  className="focus:ring-blue-500 shadow-md focus:border-blue-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md"
                  placeholder="x@y.com"
                />
                <div className="absolute inset-y-0 right-0 flex items-center">
                  ...
                  <div className="flex lg:justify-start">
                    <div className="rounded-md shadow">
                      <a
                        href="#"
                        className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-sm rounded-md text-white bg-blue-500 hover:bg-blue-700 md:py-4 md:px-10"
                      >
                        Search
                      </a>
                    </div>
